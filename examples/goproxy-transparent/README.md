...
Example routing rules are included in [proxy.sh](https://goproxy/blob/master/examples/goproxy-transparent/proxy.sh) but are best when set up using your distribution's configuration.
