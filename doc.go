...
1. https://goproxy/tree/master/examples/goproxy-avgsize
...
3. https://goproxy/blob/master/examples/goproxy-httpdump/
...
4. https://goproxy/tree/master/examples/goproxy-no-reddit-at-worktime

Will allow browsing to reddit.com between 8:00am and 17:00pm

5. https://goproxy/tree/master/examples/goproxy-jquery-version

Will warn if multiple versions of jquery are used in the same domain.

6. https://goproxy/blob/master/examples/goproxy-upside-down-ternet/
